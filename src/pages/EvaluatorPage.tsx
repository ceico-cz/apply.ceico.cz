...
type Assignment = { id: number; status: AssignmentStatus; application: Application; campaign: Campaign; evaluation: { scores: Record<string, number>; comments: string; submitted_at: string | null; normalized_total: number } | null }
