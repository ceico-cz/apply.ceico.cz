  ...
  return <>
    <header className="site-header">
      ...
      {!isLandingPage && <nav aria-label="Main navigation">
        ...
        {user && (user.organizer_approved || user.campaign_operator) && <NavLink to="/organizer/audit">Audit log</NavLink>}
        {user?.is_system_admin && <NavLink to="/admin">Portal admin</NavLink>}
        {user?.is_system_admin && <NavLink to="/admin/audit">Global audit</NavLink>}
